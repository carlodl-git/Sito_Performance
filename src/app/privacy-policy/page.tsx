    ...
    <>
      ...
      <section className="section-padding bg-white">
        ...
        >
          ...
          <p>Il periodo di conservazione dei dati personali di cui sopra e&apos; in linea con le previsioni normative vigenti.</p>
